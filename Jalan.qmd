...
<qgis version="3.32.0-Lima">
  <identifier>Jalan_BandaAceh</identifier>
  <parentidentifier></parentidentifier>
  <language>ENG</language>
  <type>dataset</type>
  <title>Jalan_BandaAceh</title>
...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link description="" url="file://\\PSJSDS-4-PC\G$\TrainingPakuan.gdb" type="Local Area Network" size="" mimeType="" format="" name="File Geodatabase Feature Class"/>
  </links>
  <dates/>
  <fees></fees>
